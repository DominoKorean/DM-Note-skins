...
![alt text](../../image/glassic/guide01.png)
...
![alt text](../../image/glassic/guide02.png)

|클래스 이름|아이콘|
|:-:|:-:|
|clear|![](DJMAX/logo/clear.svg)|
|fail|![](DJMAX/logo/fail.svg)|
|crown|![](DJMAX/logo/crown.svg)|
|crown_side|![](DJMAX/logo/crown_side.svg)|


클래스 이름 옆에 띄어쓰기 없이 대소문자 지켜서 `Black`이라고 쓰면  
로고 색이 텍스트랑 동일한 흰색으로 변함  

![alt text](../../image/glassic/guide03.png) ![alt text](../../image/glassic/guide04.png)
